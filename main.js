window.onload = function(){
    ...
    startSound.src = "https://cloud-n2vagvsp0-hack-club-bot.vercel.app/0start_audio.mp4";
    startSound.volume = 0.6;
    
    var shootSound = new Audio();
    shootSound.src = "https://cloud-ds470utp3-hack-club-bot.vercel.app/0arrow_audio.mp4";
    
    var hitSound = new Audio();
    hitSound.src = "https://cloud-e8836z1xu-hack-club-bot.vercel.app/0cartoon-arrow-hit-6700__mp3cut.net__audio.mp4";
    
    var bgSound = new Audio();
    bgSound.src = "https://cloud-4cols428v-hack-club-bot.vercel.app/0game-music-loop-7-145285_audio.mp4"//"music2.ogg";
    bgSound.loop = true;
    bgSound.volume = 0.3;
    
    var endSound = new Audio();
    endSound.src = "https://cloud-n2vagvsp0-hack-club-bot.vercel.app/0start_audio.mp4";
    endSound.volume = 0.6;
    
    var successSound = new Audio();
    successSound.src = "https://cloud-i9w1x8k6n-hack-club-bot.vercel.app/0success-221935_audio.mp4";
    
    var highScoreSound = new Audio();
    highScoreSound.src = "https://cloud-ljftmbnlb-hack-club-bot.vercel.app/0crowd-cheering-198411__mp3cut.net__audio.mp4";
